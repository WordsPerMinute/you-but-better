...
user_2 = User.create(username: "josh.c", password: "fortesting", email: "josh.c@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80204, photo: "assets/user_photo/default.jpg")
...
goal_2 = Goal.create(title: "read daily", specific_goal: "Read some good stuff for at least 30 mins every day", why: "I want more inpsiration", months: 2, attainable: true, current_action: "set alarm for 8pm to go read", private: false, goal_category: goal_spiritual, user: user_2)
...
user_3 = User.create(username: "jorge.s", password: "fortesting", email: "jorge.s@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80204, photo: "assets/user_photo/default.jpg")
...
user_4 = User.create(username: "john.r", password: "fortesting", email: "john.r@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80204, photo: "assets/user_photo/default.jpg")
...
user_5 = User.create(username: "parker.b", password: "fortesting", email: "parker.b@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80204, photo: "assets/user_photo/default.jpg")
...
user_6 = User.create(username: "kat.s", password: "fortesting", email: "kat.s@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80205, photo: "assets/user_photo/default.jpg")
...
user_7 = User.create(username: "lillian.b", password: "fortesting", email: "lillian.b@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80205, photo: "assets/user_photo/default.jpg")
...
user_8 = User.create(username: "evan.g", password: "fortesting", email: "evan.g@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80205, photo: "assets/user_photo/default.jpg")
...
user_9 = User.create(username: "bradley.h", password: "fortesting", email: "bradley.h@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80205, photo: "assets/user_photo/default.jpg")
...
user_10 = User.create(username: "tissiana.a", password: "fortesting", email: "tissiana.a@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80205, photo: "assets/user_photo/default.jpg")
...
user_11 = User.create(username: "aaron.b", password: "fortesting", email: "aaron.b@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80302, photo: "assets/user_photo/default.jpg")
...
user_12 = User.create(username: "miwha", password: "fortesting", email: "miwha@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80302, photo: "assets/user_photo/default.jpg")
...
user_13 = User.create(username: "alice", password: "fortesting", email: "alice@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80302, photo: "assets/user_photo/default.jpg")
...
user_14 = User.create(username: "rachel.e", password: "fortesting", email: "rachel.e@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80302, photo: "assets/user_photo/default.jpg")
...
user_15 = User.create(username: "aj.d", password: "fortesting", email: "aj.d@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80303, photo: "assets/user_photo/default.jpg")
...
user_16 = User.create(username: "patrick.c", password: "fortesting", email: "patrick.c@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80303, photo: "assets/user_photo/default.jpg")
...
user_17 = User.create(username: "adam.s", password: "fortesting", email: "@email.com", bio: Faker::GreekPhilosophers.quote, zip: 80303, photo: "assets/user_photo/default.jpg")
